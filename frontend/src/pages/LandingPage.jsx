        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="font-display text-xl font-bold">Seedling</span>
            </div>
            ...
            <div className="flex gap-6">
              <a href="https://github.com/ghwmelite-dotcom/seedling" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-emerald-400 transition-colors">
                GitHub
              </a>
              <a href="/app" className="text-slate-400 hover:text-emerald-400 transition-colors">
                Launch App
              </a>
            </div>
          </div>
